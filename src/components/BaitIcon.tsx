...
const BAIT_MAP: { file: string; matches: string[] }[] = [
  ...
  { file: 'swimbait',           matches: ['swimbait', 'swim bait', 'paddle tail', 'boot tail', 'keitech', 'shad tail', 'swimsenko'] },
  ...
  { file: 'creature',           matches: ['creature', 'brush hog', 'beaver', 'rage bug', 'hula grub', 'missile baits', 'd bomb', 'rage chunk', 'zoom brush hog', 'havoc'] },
