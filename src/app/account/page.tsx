...
${summary.today ? `<h2>Today's Recommendation</h2><div class="intel">${summary.today}</div>` : ''}
${summary.secondaryRec ? `<h2>Alternative Approach</h2><div class="intel">${summary.secondaryRec}</div>` : ''}
