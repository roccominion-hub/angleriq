...
const SOURCES = [
  { url: 'https://tpwd.texas.gov/fishboat/fish/recreational/lakes/bridgeport/', sourceType: 'article', tournament: undefined, org: 'TPWD', date: '2023-01-01', notes: 'TPWD Lake Bridgeport fishing guide' },
  { url: 'https://www.bassresource.com/lakes/bridgeport-texas/', sourceType: 'article', tournament: undefined, org: 'BassResource', date: '2022-06-01', notes: 'BassResource Lake Bridgeport guide' },
  { url: 'https://www.takemefishing.org/texas/fishing/lakes-rivers/lake-bridgeport/', sourceType: 'article', tournament: undefined, org: 'TakeMeFishing', date: '2022-01-01', notes: 'Lake Bridgeport fishing overview' },
  { url: 'https://www.wired2fish.com/bass-fishing/lake-bridgeport-texas-bass-fishing', sourceType: 'article', tournament: undefined, org: 'Wired2Fish', date: '2022-05-01', notes: 'Bass fishing tips for Lake Bridgeport TX' },
  { url: 'https://www.bassmaster.com/fishing-lake/lake-bridgeport-texas', sourceType: 'article', tournament: undefined, org: 'Bassmaster', date: '2022-01-01', notes: 'Bassmaster Lake Bridgeport overview' },
]
