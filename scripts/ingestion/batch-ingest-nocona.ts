...
const LAKE = 'Lake Nocona'; const STATE = 'TX'

const SOURCES = [
  { url: 'https://tpwd.texas.gov/fishboat/fish/recreational/lakes/nocona/', sourceType: 'article', tournament: undefined, org: 'TPWD', date: '2023-01-01', notes: 'TPWD Lake Nocona fishing guide' },
  { url: 'https://www.bassresource.com/lakes/nocona-texas/', sourceType: 'article', tournament: undefined, org: 'BassResource', date: '2022-06-01', notes: 'BassResource Lake Nocona guide' },
  { url: 'https://www.takemefishing.org/texas/fishing/lakes-rivers/lake-nocona/', sourceType: 'article', tournament: undefined, org: 'TakeMeFishing', date: '2022-01-01', notes: 'Lake Nocona fishing overview' },
  { url: 'https://www.wired2fish.com/bass-fishing/lake-nocona-texas-bass-fishing', sourceType: 'article', tournament: undefined, org: 'Wired2Fish', date: '2022-05-01', notes: 'Bass fishing tips for Lake Nocona TX' },
]
