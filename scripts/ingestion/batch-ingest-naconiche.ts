...
const SOURCES = [
  { url: 'https://tpwd.texas.gov/fishboat/fish/recreational/lakes/naconiche/', sourceType: 'article', tournament: undefined, org: 'TPWD', date: '2023-01-01', notes: 'TPWD Lake Naconiche fishing guide' },
  { url: 'https://www.bassresource.com/lakes/naconiche-texas/', sourceType: 'article', tournament: undefined, org: 'BassResource', date: '2022-06-01', notes: 'BassResource Lake Naconiche guide' },
  { url: 'https://www.takemefishing.org/texas/fishing/lakes-rivers/lake-naconiche/', sourceType: 'article', tournament: undefined, org: 'TakeMeFishing', date: '2022-01-01', notes: 'Lake Naconiche fishing overview' },
  { url: 'https://www.wired2fish.com/bass-fishing/lake-naconiche-texas-bass-fishing', sourceType: 'article', tournament: undefined, org: 'Wired2Fish', date: '2022-05-01', notes: 'Bass fishing tips for Lake Naconiche TX' },
]
