...
const SOURCES = [
  { url: 'https://tpwd.texas.gov/fishboat/fish/recreational/lakes/granbury/', sourceType: 'article', tournament: undefined, org: 'TPWD', date: '2023-01-01', notes: 'TPWD Lake Granbury fishing guide' },
  { url: 'https://www.bassresource.com/lakes/granbury-texas/', sourceType: 'article', tournament: undefined, org: 'BassResource', date: '2022-06-01', notes: 'BassResource Lake Granbury guide' },
  { url: 'https://www.takemefishing.org/texas/fishing/lakes-rivers/lake-granbury/', sourceType: 'article', tournament: undefined, org: 'TakeMeFishing', date: '2022-01-01', notes: 'Lake Granbury fishing overview' },
  { url: 'https://www.wired2fish.com/bass-fishing/lake-granbury-texas-bass-fishing', sourceType: 'article', tournament: undefined, org: 'Wired2Fish', date: '2022-05-01', notes: 'Bass fishing tips for Lake Granbury TX' },
  { url: 'https://www.bassmaster.com/fishing-lake/lake-granbury-texas', sourceType: 'article', tournament: undefined, org: 'Bassmaster', date: '2022-01-01', notes: 'Bassmaster Lake Granbury overview' },
]
