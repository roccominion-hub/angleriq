...
const LAKE = 'Lake Pinkston'; const STATE = 'TX'

const SOURCES = [
  { url: 'https://tpwd.texas.gov/fishboat/fish/recreational/lakes/pinkston/', sourceType: 'article', tournament: undefined, org: 'TPWD', date: '2023-01-01', notes: 'TPWD Lake Pinkston fishing guide' },
  { url: 'https://www.bassresource.com/lakes/pinkston-texas/', sourceType: 'article', tournament: undefined, org: 'BassResource', date: '2022-06-01', notes: 'BassResource Lake Pinkston guide' },
  { url: 'https://www.takemefishing.org/texas/fishing/lakes-rivers/lake-pinkston/', sourceType: 'article', tournament: undefined, org: 'TakeMeFishing', date: '2022-01-01', notes: 'Lake Pinkston fishing overview' },
  { url: 'https://www.wired2fish.com/bass-fishing/lake-pinkston-texas-bass-fishing', sourceType: 'article', tournament: undefined, org: 'Wired2Fish', date: '2022-05-01', notes: 'Bass fishing tips for Lake Pinkston TX' },
]
