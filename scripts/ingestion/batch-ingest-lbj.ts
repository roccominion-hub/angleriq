...
const LAKE = 'Lake LBJ'; const STATE = 'TX'

const SOURCES = [
  { url: 'https://tpwd.texas.gov/fishboat/fish/recreational/lakes/lbj/', sourceType: 'article', tournament: undefined, org: 'TPWD', date: '2023-01-01', notes: 'TPWD Lake LBJ fishing guide' },
  { url: 'https://www.bassresource.com/lakes/lbj-texas/', sourceType: 'article', tournament: undefined, org: 'BassResource', date: '2022-06-01', notes: 'BassResource Lake LBJ guide' },
  { url: 'https://www.takemefishing.org/texas/fishing/lakes-rivers/lake-lbj/', sourceType: 'article', tournament: undefined, org: 'TakeMeFishing', date: '2022-01-01', notes: 'Lake LBJ fishing overview' },
  { url: 'https://www.wired2fish.com/bass-fishing/lake-lbj-texas-bass-fishing', sourceType: 'article', tournament: undefined, org: 'Wired2Fish', date: '2022-05-01', notes: 'Bass fishing tips for Lake LBJ TX' },
  { url: 'https://www.bassmaster.com/fishing-lake/lake-lbj-texas', sourceType: 'article', tournament: undefined, org: 'Bassmaster', date: '2022-01-01', notes: 'Bassmaster Lake LBJ overview' },
]
