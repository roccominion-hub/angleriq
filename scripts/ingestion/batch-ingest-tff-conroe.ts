...
const KNOWN_THREADS: { url: string; notes: string }[] = [
  ...
  { url: 'https://texasfishingforum.com/forums/ubbthreads.php/topics/14071712/lake-conroe', notes: 'Lake Conroe fishing report' },
  { url: 'https://texasfishingforum.com/forums/ubbthreads.php/topics/12993354/mlf-bass-pro-tour-stop-2-lake-conroe', notes: 'MLF Bass Pro Tour Lake Conroe - tournament patterns' },
]
