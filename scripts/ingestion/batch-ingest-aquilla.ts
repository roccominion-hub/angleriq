...
const LAKE = 'Lake Aquilla'; const STATE = 'TX'

const SOURCES = [
  { url: 'https://tpwd.texas.gov/fishboat/fish/recreational/lakes/aquilla/', sourceType: 'article', tournament: undefined, org: 'TPWD', date: '2023-01-01', notes: 'TPWD Lake Aquilla fishing guide' },
  { url: 'https://www.bassresource.com/lakes/aquilla-texas/', sourceType: 'article', tournament: undefined, org: 'BassResource', date: '2022-06-01', notes: 'BassResource Lake Aquilla guide' },
  { url: 'https://www.takemefishing.org/texas/fishing/lakes-rivers/lake-aquilla/', sourceType: 'article', tournament: undefined, org: 'TakeMeFishing', date: '2022-01-01', notes: 'Lake Aquilla fishing overview' },
  { url: 'https://www.wired2fish.com/bass-fishing/lake-aquilla-texas-bass-fishing', sourceType: 'article', tournament: undefined, org: 'Wired2Fish', date: '2022-05-01', notes: 'Bass fishing tips for Lake Aquilla TX' },
]
